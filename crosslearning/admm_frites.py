...
#countries = [ 'URY','USA', 'ESP', 'FRA','BRA','MEX','PRY', 'ITA']
...
for country in countries:
    ...
    I_data, _ = cutdata(datasets[country]['train']['array'][1, :],proportion=0.9)  # Cut data to include only up to 0.6*Imax
